...
export const OnboardingProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    document.addEventListener('transitionrun', scheduleTargetVisibilityUpdate, true);
    document.addEventListener('transitionend', scheduleTargetVisibilityUpdate, true);
    document.addEventListener(
      'transitioncancel',
      scheduleTargetVisibilityUpdate,
      true,
    );
    document.addEventListener('animationstart', scheduleTargetVisibilityUpdate, true);
    document.addEventListener('animationend', scheduleTargetVisibilityUpdate, true);
    ...
    return () => {
      ...
      window.removeEventListener('scroll', scheduleTargetVisibilityUpdate, true);
